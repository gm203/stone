...
public class RedisUtils {
	...
	public static String getTotalKey(String className, String keyId) {
		...
		return RedisUtils.KEY_PREFIX + className + RedisUtils.TOTAL_KEY + Md5Utils.MD5(keyId).substring(0, 20);
	}
	...
	public static String getFindListKey(String className, String keyId) {
		...
		return RedisUtils.KEY_PREFIX + className + RedisUtils.FIND_LIST_KEY + Md5Utils.MD5(keyId).substring(0, 20);
	}
	...
	public static String getFindListFirstKey(String className, String keyId) {
		...
		return RedisUtils.KEY_PREFIX + className + RedisUtils.FIND_LIST_FIRST_KEY
				+ Md5Utils.MD5(keyId).substring(0, 20);
	}
	...
	public static String getFindPageKey(String className, String keyId) {
		...
		return RedisUtils.KEY_PREFIX + className + RedisUtils.FIND_PAGE_KEY + Md5Utils.MD5(keyId).substring(0, 20);
	}
