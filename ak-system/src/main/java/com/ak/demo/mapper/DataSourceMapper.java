...
public interface DataSourceMapper {
	...
	@Select({ "select datasource_name,database_ip,database_port,database_name,database_username,"
			+ "database_driver_class_name,database_password,gmt_create,gmt_modified FROM other_datasource_meta" })
	List<DataSource> getAllDataSources();

	@Select({ "select datasource_name,database_ip,database_port,database_name,database_username,"
			+ "database_driver_class_name,database_password,gmt_create,gmt_modified FROM other_datasource_meta WHERE datasource_name = #{datasourceName}" })
